...
export default function AcademicTeam() {
    ...
    const academicTeam = teamStructure.academicTeam;
            ...
            <section className="bg-gradient-to-br from-[#2A535A] to-[#23484E] text-white py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-6">Academic Team</h1>
                        <p className="text-xl max-w-3xl mx-auto">
                            Meet our academic team responsible for the educational content and quality of our programs.
                        </p>
                    </div>
                </div>
            </section>
